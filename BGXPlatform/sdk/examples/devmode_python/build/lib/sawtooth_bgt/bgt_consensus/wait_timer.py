...
class WaitTimer:
    ...
    def create_wait_timer(cls,
        ...
        Returns:
            journal.consensus.bgt.wait_timer.WaitTimer: A new wait timer.
        """

        # Create an enclave timer object and then use it to create a
        # WaitTimer object
        enclave_timer = \
            bgt_enclave_module.create_wait_timer(
                sealed_signup_data,
                validator_address,
                previous_certificate_id,
    ...
    def enclave_wait_timer(self):
        ...
        Returns:
            <bgt_enclave_module>.WaitTimer: The deserialized enclave timer
                object.
        """
