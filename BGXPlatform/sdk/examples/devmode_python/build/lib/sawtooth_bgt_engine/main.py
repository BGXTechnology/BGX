...
from sawtooth_bgt_engine.engine import BgtEngine

from sawtooth_bgt.config.path import load_path_config
...
def main(args=None):
    ...
    try:
        log_config = get_log_config('bgt-engine-log-config.toml')
        if log_config is None:
            log_config = get_log_config('bgt-engine-log-config.yaml')
        ...
        LOGGER.exception("Error starting BGT Engine")
    finally:
        pass
