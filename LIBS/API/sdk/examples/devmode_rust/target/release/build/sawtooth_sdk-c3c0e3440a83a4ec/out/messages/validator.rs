...
impl ::protobuf::Message for MessageList {
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        unsafe {
            descriptor.get(|| {
                ...
                ::protobuf::reflect::MessageDescriptor::new::<MessageList>(
                    "MessageList",
                    fields,
    ...
    fn default_instance() -> &'static MessageList {
        static mut instance: ::protobuf::lazy::Lazy<MessageList> = ::protobuf::lazy::Lazy {
            lock: ::protobuf::lazy::ONCE_INIT,
            ptr: 0 as *const MessageList,
        };
        unsafe {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x03(\x0b2\x08.MessageR\x08messages\"\xa5\x1f\n\x07Message\x127\n\x0cmes\
    ...
    \x07content\x18\x03\x20\x01(\x0cR\x07content\"\x9f\x1e\n\x0bMessageType\
    ...
    \n\x1dCONSENSUS_NOTIFY_BLOCK_COMMIT\x10\x8a\x07\x12\x19\n\x14CONSENSUS_N\
    OTIFY_ACK\x10\xe7\x07B(\n\x15sawtooth.sdk.protobufP\x01Z\rvalidator_pb2b\
    \x06proto3\
";
