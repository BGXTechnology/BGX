...
class Dispatcher(InstrumentedThread):
    ...
    def _process(self, message_id):
        ...
        LOGGER.info("Call preprocessor for %s preprocessor %s",get_enum_name(message_info.message_type),preprocessor)
    ...
    def execute(self, connection_id, message_content, callback):
        def wrapped(message_content):
            try:
                ...
                LOGGER.info("PreprocessorManager:preprocessor: DONE")
            except DecodeError:
                LOGGER.exception(
